% =================================================================
% Estimate benchmark model with all same parameters for V/NV
% Use the top 20 best estimates from the fixed-epsilon version 
% (fixed at 490.6)
% =================================================================
...
dataFile = strcat('same-bench-best-',datestr(now,'dd-mmm-yyyy-HH_MM'));
...
% NOTE: this will pull the top X estimates from the results with fixed
% sigma epsilon= 490.6
noSearchInits=20

search_init_file = 'fixsige490'
