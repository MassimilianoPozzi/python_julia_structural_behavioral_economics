% =================================================================
% Estimate the model
% Same parameters for V/NV, fix sigma epsilon to 490.6
% =================================================================
...
dataFile = strcat('same-fixsige490-',datestr(now,'dd-mmm-yyyy-HH_MM'));
...
rng(747)
[searchInits,lower_start,upper_start] =  getSearchInits_fix_sigep(fixed_sigma_eps,noSearchInits,L_setting,...
