...
% "Enogenous voting" version of the code, but parameter inputs will force
% 100% voters or 100% non-voters (separate estimations for voters and
% non-voters)
% Note: h0 moments only show for relevant group
% =================================================================

function [simMoments] = voteSim_vnv_sep(parameters,rand_set)
...
if Turnout_control==1
PH_NF_0d5m_nv = 9999;  
PH_NF_10d10m_nv = 9999;
PH_NF_10d5m_nv = 9999;
end
