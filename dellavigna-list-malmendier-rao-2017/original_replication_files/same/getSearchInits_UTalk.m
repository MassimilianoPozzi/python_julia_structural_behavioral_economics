...
% UTalk start range between -50 and 50
% =================================================================
...
if L_setting == 'cons'
    lower_start = [0.2, 0.2, eps, -50, eps, eps, eps, -20, -30, eps, eps, -1, eps, -30, 50, -50, -50]';
    upper_start = [0.4, 0.4, 0.5, eps, 50,  10,  100,  20,  10,  30,  30,  1, 20,  100, 200, 50,  50]';
end

if L_setting == 'dist' 
    lower_start = [0.2, 0.2, eps, -50, eps, eps, eps, -20, -30, eps, eps, -1, eps, -30, 50, -50, -50]';
    upper_start = [0.4, 0.4, 0.5, eps, 50,  10,  100,  20,  10,  30,  30,  1, 1,   100, 200, 50,  50]';
end
