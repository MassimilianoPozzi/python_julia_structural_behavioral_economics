% =================================================================
% Estimate model for voters only
% =================================================================
...
dataFile = strcat('non-endog-v-',datestr(now,'dd-mmm-yyyy-HH_MM'));
...
momentsToUse=voterMoments; % or nonvoterMoments
display 'voterMoments'; % or nonvoterMoments
