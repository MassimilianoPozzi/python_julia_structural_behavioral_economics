...
% Note - this code was written to allow for non-selection param to vary 
%   across voters and non-voters but in practice fixes them to be the same  
%   when parameter values are assigned
% Utility from talking about politics - only affects utilVotingQuestion
% =================================================================

function [simMoments] = voteSimEndog_UTalk(parameters,rand_set)
