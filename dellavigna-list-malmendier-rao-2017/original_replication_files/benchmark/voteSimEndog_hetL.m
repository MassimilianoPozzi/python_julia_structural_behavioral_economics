...
% Benchmark, allow non-selection param to vary across voter and non-voter
% Assumes exponential distribution for L 
% =================================================================

function [simMoments] = voteSimEndog_hetL(parameters,rand_set)
...
% Taking 50/50 average across NI and I treatments
