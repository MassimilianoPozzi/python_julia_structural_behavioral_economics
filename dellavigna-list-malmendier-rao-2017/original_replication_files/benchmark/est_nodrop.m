% =================================================================
% Different V/NV parameters
% Estimate the model with empirical moments that don't drop 
% households with no solicitor signs or otherwise flagged as to eliminate
% =================================================================
...
dataFile = strcat('nodrop-',datestr(now,'dd-mmm-yyyy-HH-MM'));
