...
% 10% of apparent non-voters are voters
% no measurement error in turnout
% =================================================================

function [simMoments] = voteSimEndog_meas_vnv(parameters,rand_set)
...
N_apparent_v = round((0.9 / (0.9^2 - 0.1^2)) * (length(voterIndex) - (0.1 / 0.9) * length(nonvoterIndex)));
...
% =================================================================
% Lying if Asked -  with mismeasurement, opposite if you appear as opposite
% ================================================================
