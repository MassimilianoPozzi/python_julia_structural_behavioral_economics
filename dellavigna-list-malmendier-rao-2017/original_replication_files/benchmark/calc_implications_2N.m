...
% Assumes asked about voting twice as often
% =================================================================

function [implications]= calc_implications_2N(parameters,sim_voters,L_setting,rand_set)
...
% =========================================
simSize=sim_voters; 
N=5.4*2; % Number of times asked in Congressional
N_P=10.1*2; % times asked in presidential
