...
function [searchInits,lower_start,upper_start] = getSearchInits_fix_sigsvsn(fixed_sigma_svsn,...
...
for i=1:noSearchInits*X
    %replace fixed sigma sv sn
    searchInits_all(17,i) = fixed_sigma_svsn;
    searchInits_all(18,i) = fixed_sigma_svsn;
    %record turnout
