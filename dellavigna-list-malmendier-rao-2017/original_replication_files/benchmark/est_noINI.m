% =================================================================
% Estimate the model
% Different V/NV parameters, estimate without using I/NI moments
% =================================================================
...
dataFile = strcat('noINI-',datestr(now,'dd-mmm-yyyy-HH-MM'));
...
display 'fixedRho';
momentsToUse=noINIMoments;
display 'noINIMoments';
