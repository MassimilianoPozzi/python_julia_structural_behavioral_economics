...
% Assumed asked about voting twice as often
% =================================================================

function [simMoments] = voteSimEndog_2N(parameters,rand_set)
...
N=2 * 5.4; % Number of times asked in Congressional
N_P=2 * 10.1; % times asked in presidential
