% =================================================================
% Estimate the model
% Different V/NV parameters, fixing sigma epsilon
% =================================================================
...
dataFile = strcat('fixsige318-',datestr(now,'dd-mmm-yyyy-HH-MM'));
...
% Fix sigma epsilon in search
rng(747)
[searchInits,lower_start,upper_start] = getSearchInits_fix_sigep(fixed_sigma_eps,noSearchInits,L_setting,sim_voters,rand_set,votesimFile);
for j=1:noOfParams
...
upperBound=[1,     1,   1,   1, 0.5, 0.5,  100,  100, 100, 100, 100, 100, ...
    200, 200,  100,  100, 100, 100,  1, 50,  500, 2000];
end
if L_setting == 'dist' 
lowerBound=[eps, eps, eps, eps, eps, eps, -100, -100, eps, eps, eps, eps, ...
    eps, eps, -100, -100, eps, eps, -1, eps, -500, eps];
upperBound=[1,     1,   1,   1, 0.5, 0.5,  100,  100, 100, 100, 100, 100, ...
    200, 200,  100,  100, 100, 100,  1, 1,  500, 2000];
end
