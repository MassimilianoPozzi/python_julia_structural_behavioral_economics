% =================================================================
% Estimate the model
% Different V/NV parameters, assumed asked about voting half as often
% =================================================================
...
dataFile = strcat('halfN-',datestr(now,'dd-mmm-yyyy-HH-MM'));
outputFile = strcat(dataFile,'.txt');
diary(strcat(outputDir,outputFile));

% set votesim file that generates moments
votesimFile = @voteSimEndog_halfN
calc_implicationsFile = @calc_implications_halfN
