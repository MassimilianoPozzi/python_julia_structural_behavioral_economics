% =================================================================
% Estimate the model
% Different V/NV parameters, estimate without incentive to lie moments
% fix sigma sv sn at 10
% =================================================================
...
dataFile = strcat('nolie-fix-sigsvsn10-',datestr(now,'dd-mmm-yyyy-HH-MM'));
...
svyEstimates  = [0.37, 0.37, 0.34, 0.34, 0.1, 0.1, -28, -28, 30, 30, ...
    1, 1, 42, 42, -4, -13, fixed_sigma_svsn, fixed_sigma_svsn, 0, cons_fixedL, fixed_mu_eps, fixed_sigma_eps]';
end
if L_setting == 'dist' 
svyEstimates  = [0.37, 0.37, 0.34, 0.34, 0.1, 0.1, -28, -28, 30, 30, ...
    1, 1, 42, 42, -4, -13, fixed_sigma_svsn, fixed_sigma_svsn, 0, 0.05, fixed_mu_eps, fixed_sigma_eps]';
end
...
paramsToUse=fixedRho_SigSvSn;  % or fixedL_Rho
display 'fixedRho_SigSvSn';
momentsToUse=noIncentLyingMoments;
display 'noIncentLyingMoments';
...
% NOTE: this picks a bunch of random start points for everything but the
% copy parameters

% Fix random seed, get back start space bounds for display
rng(747)
[searchInits,lower_start,upper_start] = getSearchInits_fix_sigsvsn(fixed_sigma_svsn, ...
