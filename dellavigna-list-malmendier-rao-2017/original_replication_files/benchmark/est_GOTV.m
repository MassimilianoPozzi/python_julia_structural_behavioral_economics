% =================================================================
% Estimate the model
% Different V/NV parameters, include GOTV moment in estimation
% =================================================================
...
dataFile = strcat('GOTV-',datestr(now,'dd-mmm-yyyy-HH-MM'));
...
display 'fixedRho';
momentsToUse=C_GOTVMoments;
display 'C_GOTVMoments';
